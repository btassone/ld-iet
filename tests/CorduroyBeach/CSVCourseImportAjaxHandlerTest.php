...
class ImportAdminAjaxHandlerTest extends \WP_UnitTestCase {
	...
	public function setUp() {
		...
		$this->import_func = include LD_IET_SETTINGS_BASE . "AjaxHandlers/ImportCSV.php";
	...
	public function test_ajax_handler_output_and_ensure_correct_data() {
		...
		$iaah = new CSVCourseImportAjaxHandler('some_name', 'some_action_name', $this->csv_json_obj, $this->options, $this->import_func, $this->csv_local_path);
