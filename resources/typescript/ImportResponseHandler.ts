namespace CorduroyBeach {
    export enum ImportResponseStatuses {
        NoFile,
        Pending,
        Processing,
        Finished,
    ...
    export class ImportResponseHandler {
        ...
        static get response_status():CorduroyBeach.ImportResponseStatuses {
            return this._response_status;
        }
        static set response_status(value:CorduroyBeach.ImportResponseStatuses) {
